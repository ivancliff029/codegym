                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href=" {{ route('menu') }} ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-menu-button-wide-fill" viewBox="0 0 16 16">
                        ...
                        <li class="nav-item" id="profile-icon">
                            <a href=" {{ route('profile') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="maroon" class="bi bi-person-circle" viewBox="0 0 16 16">
